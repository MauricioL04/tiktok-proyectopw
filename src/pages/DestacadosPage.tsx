// src/pages/DestacadosPage.tsx
import { Link } from 'react-router-dom';
import './DestacadosPage.css'; // Crearemos los estilos para esta página

// --- Datos de Ejemplo para la Página de Destacados ---
const TOP_STREAMERS = [
  { id: 'u1', name: '@proGamer', category: 'Gaming', profilePic: 'https://i.pravatar.cc/80?u=gamer' },
  { id: 'u2', name: '@djBeats', category: 'Música', profilePic: 'https://i.pravatar.cc/80?u=dj' },
  { id: 'u3', name: '@viajeroUrbano', category: 'IRL', profilePic: 'https://i.pravatar.cc/80?u=viajero' },
  { id: 'u4', name: '@fanFutbol', category: 'Deportes', profilePic: 'https://i.pravatar.cc/80?u=futbol' },
  { id: 'u5', name: '@arteDigital', category: 'Arte', profilePic: 'https://i.pravatar.cc/80?u=arte' },
];
...
export default function DestacadosPage() {
  return (
    <div className="destacados-page">
      ...
      {/* Sección de Streamers Destacados */}
      <section>
